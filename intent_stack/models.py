"""
Data Models & Telemetry Definitions for IntentStack: Hierarchical Sub-Dialog & Multi-Turn Interruption Resumer Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Pushdown Automata Dialogue Management"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
