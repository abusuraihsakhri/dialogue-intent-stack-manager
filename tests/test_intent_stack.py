...
import pytest
from intent_stack.models import FrontierPayload, ExecutionStatus
from intent_stack.engine import FrontierDomainEngine
from intent_stack.agents import InterruptionClassifierAgent, StackPushPopControllerAgent, ContextResumptionSynthesizerAgent, IntentStackCoordinator
from intent_stack.cli import main


def test_sub_agents():
    a1 = InterruptionClassifierAgent()
    ...
    a2 = StackPushPopControllerAgent()
    ...
    a3 = ContextResumptionSynthesizerAgent()
...
def test_coordinator():
    ...
    assert "Pushdown Automata Dialogue Management" in ans or "specifications" in ans
