"""
Automated Pytest for dialogue-intent-stack-manager Enrichment Modules.
"""
import sys
...
from enrichment import (
    IntentConfidenceThresholdsEngine,
    MultilanguageIntentDetectionEngine,
    IntentDriftDetectionEngine,
    StackPersistenceToVectorDbEngine,
    IntenttotoolRoutingEngine,
    DialogueintentstackmanagerEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = DialogueintentstackmanagerEnrichmentSuite()
